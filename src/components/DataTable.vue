      ...
      <table>
        <thead>
          <tr>
            ...
            <th v-for="field in columns" :key="field" @click="$emit('sort', field)">
              {{ field }}
